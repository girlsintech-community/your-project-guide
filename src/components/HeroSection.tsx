...
const HeroSection = () => {
  return <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <img src={heroBg} alt="EmpowerHer abstract background" className="w-full h-full object-cover" />
      ...
      <div className="container relative z-10 px-6 py-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          delay: 0.4
            ...
            <Button variant="hero" size="xl" onClick={() => window.open("https://events.cmxhub.com/events/details/cmx-mohali-presents-empowerher-elevate-inspire-lead/", "_blank")}>
              Register Now
            </Button>
